                            ...
                            <div class="recordsContainer">
                                <?php
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        echo "<p style='padding: 5px; text-align: center; font-size: 12px'>DISPLAY NAME</p>";
                                        echo "</div>";
                                        echo "<div style='flex: 1; display: flex; justify-content: center; align-items: center;'>";
                                        echo "<p style='padding: 5px; text-align: center; font-size: 12px'>DETAILS</p>";
                                        echo "</div>";
                                        echo "<div style='flex: 1; display: flex; justify-content: center; align-items: center;'>";
                                        echo "<p style='padding: 5px; text-align: center; font-size: 12px'>DELETE</p>";
                                        echo "</div>";
                                        echo "</div>";
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<div style='flex: 1; display: flex; justify-content: center; align-items: center;'>";
                                            echo "<p class='recordName' style='padding: 5px; text-align: center; font-size: 12px'>" . htmlspecialchars($row['disp_name']) . "</p>";
                                            echo "</div>";
                                            echo "<div style='flex: 1; display: flex; justify-content: center; align-items: center;'>";
                                            echo "<button style='padding: 5px; text-align: center; font-size: 12px' onclick=\"location.href='viewdisplaydetails.php?id=" . htmlspecialchars($row['disp_id']) . "'\">VIEW</button>";
                                            echo "</div>";
                                            echo "<div style='flex: 1; display: flex; justify-content: center; align-items: center;'>";
                                            echo "<button style='padding: 5px; text-align: center; font-size: 12px' onclick=\"location.href='deletedisplay.php?id=" . htmlspecialchars($row['disp_id']) . "'\">DELETE</button>";
                                            echo "</div>";
                                            echo "</div>";
                                        }
                                    } else {
