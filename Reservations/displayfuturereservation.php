                ...
                <div class="headerChild2">
                    ...
                    <div class="grandchild4">
                        ...
                        <div class="mgaButton">
                            ...
                            <button class="chosenone" onclick="openFuture()"> FUTURE</button>
                        </div>
                        <br>
                        <hr>
                        ...
                        <?php
                                    ...
                                    echo "<br>";
                                    echo "<h2 style='text-align:center; letter-spacing:2px'> FUTURE RESERVATIONS </h2>";
                                    echo "<br>";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        foreach ($groups as $status => $rows) {
                                            ...
                                            if (count($rows) > 0) {
                                                ...
                                                echo "<p>No $status future reservations found.</p>";
                                                echo "<br>";
                                            }
                                        }
                                    } else {
                                        echo "<p class='noRes'>No future reservations found</p>";
                                    }
