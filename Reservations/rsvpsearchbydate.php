                            ...
                            <div class="grandchild6">
                                <?php
                                    ...
                                    if ($date) {
                                        ...
                                        echo "<h2 style='text-align:center; letter-spacing:2px; text-transform: uppercase'>Reservations for $date</h2><br>";
                                        echo "<br>";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            foreach ($groups as $status => $rows) {
                                                ...
                                                if (count($rows) > 0) {
                                                    ...
                                                    echo "<p>No $status reservations found.</p>";
                                                    echo "<br>";
                                                }
                                            }
                                        } else {
                                            echo "<p>No reservations found for $date</p>";
                                            echo "<br>";
                                        }
                                    } else {
